...
import edu.ju.asg.query.QueryBuilderUtils;

public class SemanticRelatednessValuesDTO extends ASGBaseDTO {
	/**
	...
	/**
	 * The cosine-similarity feature value
	 */
	private double cosineSimilarityFeatureValue = Double.NEGATIVE_INFINITY;
	/**
	...
	private static final String INSERT_SQL = "insert into ssc_relatedness_values "
			...
			+ "cosine_similarity_feature_value, matched_word_count, "
			+ "mismatched_word_count, minimum_word_count) values "
			+ "( ?, ?, ?, ?, ?, ?, ? ,? ,?, ? )";
	...
	/**
	 * @return the cosineSimilarityFeatureValue
	 */
	public double getCosineSimilarityFeatureValue() {
		return cosineSimilarityFeatureValue;
	}

	/**
	 * @param cosineSimilarityFeatureValue
	 *            the cosineSimilarityFeatureValue to set
	 */
	public void setCosineSimilarityFeatureValue(
			double cosineSimilarityFeatureValue) {
		this.cosineSimilarityFeatureValue = cosineSimilarityFeatureValue;
	}
	...
	protected void writeImpl(PreparedStatement ps) throws SQLException,
		...
		ps.setDouble(i++, this.getCosineSimilarityFeatureValue());
	 ...
	 * @return
	 */
	public static final List<SemanticRelatednessValuesDTO> getSemanticRelatednessValuesDTOList(
			final JdbcTemplate jdbcTemplate) {
		final StringBuilder queryStr = new StringBuilder(
				"select first_sentence_id, second_sentence_id, simple_feature_value, ");
		queryStr.append(" lesk_feature_value, lin_feature_value, path_feature_value, cosine_similarity_feature_value, ");
		...
		return QueryBuilderUtils.query(jdbcTemplate, queryStr.toString(),
				SemanticRelatednessValuesDTO.class);
	}
